...
namespace PureMVC.Tests.Core
{
	...
	public class ControllerTest : BaseTest
    {
		...
		public void HasCommand()
		{
			...
			Assert.IsTrue(controller.HasCommand(name), "Expecting controller.HasCommand(name) == true");
 		...
 		/**
  		 ...
  		 * testRegisterAndRemove. The error under test was fixed in AS3 Standard 
		...
		public void ReregisterAndExecuteCommand()
		{
			...
			var vo = new ControllerTestVO(12);
			var note = new Notification(name, vo);
